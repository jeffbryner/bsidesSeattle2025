...
tts.DvRate = 0.80; // used to set speech rate between 0 and 2, 1 = 'normal'- there are other seemingly optional parameters like pitch, language, volume.
...
// Reveal.configure({
// 	keyboard: {
// 		113: function () { tts.Synth.cancel() }, // press q to cancel speaking and clear speech queue.
// 		116: function () { tts.ToggleSpeech() },  // press t to toggle speech on/off
// 		122: function () { tts.DvIndex += 1 }  // press V to change the voice

// 	}
// });

Reveal.addKeyBinding(
	{ keyCode: 84, key: 'T', description: 'Toggle speech on/off' },
	() => {
		tts.ToggleSpeech();
	}
);
Reveal.addKeyBinding(
	{ keyCode: 86, key: 'V', description: 'Next Voice' },
	() => {
		tts.DvIndex += 1;
	}
);